...
<?php $this->start('main_content') ?>
	<h2>a propos de la chambre</h2>
	Toutes nos chambres donnent sur la rue de Seine.
	 Elles sont au nombre de deux par étage et la suite,
	  légèrement mansardée, occupe l'intégralité du dernier et sixième étage.
Les chambres double, d'une superficie moyenne de 18m²,
 se trouvent sur le palier à droite : elles ont toutes un lit queen size (160 X 200)
  et sont isolées de l'activité de l'hôtel grâce à une longue entrée au tissu
...
La suite vous assure une tranquillité totale puisque vous êtes les seuls occupant de
 l’étage et sans voisin… Cette chambre d'une superficie moyenne de 32m²,
  dispose d’une vue imprenable sur les toits de Paris et offre tout le
   confort nécessaire grâce à son lit Queen Size et son jacuzzi dans sa salle de bain de marbre gris.
Equipements dans toutes les chambres :
...
Enfin, pour plonger complétement dans l’atmosphère artistique de l’hôtel Prince de condé
 ...
 de Georges Braque et Joan Miro, présentes dans chaque chambre… Bons mots et traits d’esprit sur l’art….
